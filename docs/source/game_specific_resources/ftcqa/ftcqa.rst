...
The `Game Q&A <https://ftc-qa.firstinspires.org/>`__ is a forum/tool that
...
Once the `Game Q&A <https://ftc-qa.firstinspires.org/>`__ opens for the season
...
`FIRST Dashboard <https://my.firstinspires.org/Dashboard/>`__ accounts. Teams
...
information in the `FIRST Dashboard <https://my.firstinspires.org/Dashboard/>`__.  
...
"`one-page summary <https://ftc-qa.firstinspires.org/onepage.html>`__" of all
