...
.. grid:: 1
    ...
    .. grid-item-card:: 構造化審査面談に何を持参する必要がありますか？
    ...
    .. grid-item-card:: 審査員からどのようなフィードバックを受け取りますか？
        ...
        審査員は、チームが構造化インタビューを完了した直後にフィードバックフォームに記入します。フィードバックは最初の構造化インタビューに限定されており、フォローアップのピットインタビューやポートフォリオにおけるチームのパフォーマンスは含まれません。
